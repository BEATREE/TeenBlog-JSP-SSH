  ...
  <body>
  	...
  	%>
		...
		<div id="mainbody">
		  ...
		  <div class="blogs">
		    <ul class="bloglist">
		    <s:iterator value="#session.postList" id="post">
		      <li>
		      	<!--arrow_box 结束--> 
		        <div class="arrow_box">
		          <div class="ti"></div>
		          ...
		          <ul class="details">
		            <li class="likes"><a href='likePost.action?pId=<s:property value="#post.getPostId()"/>'>
		            <s:property value="#post.getPostLikes()"/></a></li>
		    ...
		    <aside>		
		      ...
		      <div class="viny">
		        <dl>
		          ...
		          <dd class="music">
		            <audio src="images/nf.mp3" autoplay="true" loop="true" controls ></audio>
		          </dd>
